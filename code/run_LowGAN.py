...
-skullstripped: Use this flag if the volumes are already skullstripped, because skullstripping already skullstripped volumes can cause issues
...
if __name__ == '__main__':
    ...
    parser.add_argument('-skullstripped', '--skullstripped', help='(OPTIONAL) Use this flag if the volumes are already skullstripped', action='store_true')
    ...
    if ensemble:
        ...
        if parallel:
            ...
            for fold in folds:
                list_of_arguments.append((full_subject_list, fold, os.path.abspath(args.output_dir),
