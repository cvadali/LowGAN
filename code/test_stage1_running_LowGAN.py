...
# test stage 1 of the model
def test_stage1(model_name, data_source, checkpoints_dir, output_dir, pytorch_CycleGAN_and_pix2pix_dir, direction='BtoA'):
    ...
    for plane in planes:
        ...
        # results dir
        results_dir = os.path.join(output_dir, f'results_stage1')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Test Stage 1 of LowGAN')
