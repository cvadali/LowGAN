...
def iterate_for_each_plane(subject_list, data_dir, out_dir):
    ...
    reconstructed_dir = os.path.join(data_dir, 'reconstructed_niftis')
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='Reshape nifti volumes from reconstructed niftis')
    ...
    if bool(args.parallel) == True:
        ...
        reconstructed_dir = os.path.join(os.path.abspath(args.data), 'reconstructed_niftis')
