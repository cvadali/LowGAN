...
def predict_all_subjects(weights_path, output_dir, device, images_dir,
    ...
    for fold in folds:
        ...
        output_dir_fold = os.path.join(output_dir, fold, 'recon_niftis_training_set_stage2')

        images_dir_fold = os.path.join(output_dir, fold, 'recon_niftis_training_set_reshaped_coregistered')
    
        # iterate for each subject
        for sub in full_subject_list:
            predict_single_subject(weights_path, output_dir_fold, device, sub, images_dir_fold,
                                    batch_size, patch_size, patch_overlap)
...
if __name__ == '__main__':
    ...
    predict_all_subjects(
        weights_path=Path(args.output_dir),
